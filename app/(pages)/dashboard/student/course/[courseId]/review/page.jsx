...
export default function ReviewSession() {
  ...
  useEffect(() => {
    const init = async () => {
      const { questions: qData } = await getDueQuestions(courseId)
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col max-w-2xl mx-auto p-4 md:p-6">
      ...
      <div className="flex justify-between items-center mb-6">
        ...
        {/* Visual Timer */}
        <div className={`text-sm font-mono font-bold px-3 py-1 rounded-full transition-colors ${
            timer < 5 ? 'bg-green-100 text-green-700' : 
