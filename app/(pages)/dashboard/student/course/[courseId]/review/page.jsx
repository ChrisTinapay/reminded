    ...
    >
        ...
        <div className="flex-1 min-h-0 md:overflow-y-auto md:overscroll-contain md:pr-1 space-y-3 md:space-y-3">
          ...
          <div className="flex justify-between items-center">
            <div className="flex flex-col min-w-0">
              <span className="text-xs font-bold text-indigo-600 mb-1 truncate max-w-[220px] md:max-w-md">{topicLabel}</span>
          ...
          {/* Question Card */}
          <div className="bg-white dark:bg-white/5 p-4 rounded-2xl shadow-sm border border-gray-100 dark:border-white/10 flex items-center justify-center min-h-[120px] md:min-h-0 md:max-h-[min(200px,32vh)] md:overflow-y-auto">
            <h2 className="text-lg font-bold text-gray-800 dark:text-gray-100 text-center leading-snug">
            ...
            {currentQ.choices.map((choice, idx) => {
              ...
              return (
                <button
                  ...
                  disabled={isAnswered}
                  className={`
                        py-3 px-4 md:py-2.5 md:px-3 rounded-xl text-base md:text-sm font-medium text-left transition-all duration-200 
                        shadow-sm active:scale-[0.98] min-h-[44px]
                        ${style}
                    `}
                >
                  {choice}
      ...
      {isAnswered && (
        <>
          ...
          <div className="md:hidden fixed inset-x-0 bottom-0 z-50 p-3 pb-[calc(12px+env(safe-area-inset-bottom))]">
            ...
            >
              <div className="min-w-0">
                <span
                  className={`font-bold text-base block ${feedback === 'correct' ? 'text-green-800 dark:text-green-200' : 'text-red-800 dark:text-red-200'}`}
                >
          ...
          {/* Desktop: pinned below scroll area */}
