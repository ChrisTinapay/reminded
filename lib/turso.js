    ...
    if (!dbInitialized) {
        try {
            await db.executeMultiple(`
                ...
                CREATE TABLE IF NOT EXISTS questions (id TEXT PRIMARY KEY, course_id INTEGER, material_id INTEGER, question_text TEXT NOT NULL, choices TEXT NOT NULL, correct_answer TEXT NOT NULL, bloom_level TEXT, ease_factor REAL DEFAULT 2.5, interval INTEGER DEFAULT 0, repetitions INTEGER DEFAULT 0, next_review_date DATETIME, created_at DATETIME DEFAULT CURRENT_TIMESTAMP);
                CREATE TABLE IF NOT EXISTS student_progress (id INTEGER PRIMARY KEY AUTOINCREMENT, user_id TEXT NOT NULL, course_id INTEGER NOT NULL, question_id TEXT NOT NULL, interval INTEGER DEFAULT 0, ease_factor REAL DEFAULT 2.5, next_review_date DATETIME, created_at DATETIME DEFAULT CURRENT_TIMESTAMP, UNIQUE(user_id, question_id));
